...
const u16 gObjectEventPic_Clefable[] = INCBIN_U16("graphics/object_events/pics/pokemon/clefable.4bpp");
const u16 gObjectEventPic_MoonStone[] = INCBIN_U16("graphics/object_events/pics/misc/moon_stone.4bpp");
...
const u16 gObjectEventPic_Airplane[] = INCBIN_U16("graphics/object_events/pics/misc/airplane.4bpp");
const u16 gObjectEventPic_AirplaneSmall[] = INCBIN_U16("graphics/object_events/pics/misc/airplane_small.4bpp");
...
const u16 gObjectEventPal_OldTimer[] = INCBIN_U16("graphics/object_events/palettes/old_timer.gbapal");
const u16 gObjectEventPal_N[] = INCBIN_U16("graphics/object_events/palettes/n.gbapal");
const u16 gObjectEventPal_SummitTrainer[] = INCBIN_U16("graphics/object_events/palettes/summit_trainer.gbapal");
const u16 gObjectEventPal_Ditto[] = INCBIN_U16("graphics/object_events/palettes/ditto.gbapal");
const u16 gObjectEventPal_GrottoGrass[] = INCBIN_U16("graphics/object_events/palettes/grotto_grass.gbapal");
...
// Oak's PIKACHU carrying the player on a balloon, the same five frames as the bird
// sheet, for when it is the one that FLIES (tools/make_fly_pikachu.py).
const u16 gFieldEffectObjectPic_FlyPikachu[] = INCBIN_U16("graphics/field_effects/pics/fly_pikachu.4bpp");

// BEGIN HOENN OBJECT EVENTS (generated by tools/hoenn_import/import_objevent_gfx.py)
const u32 gObjectEventPic_HoennAquaMemberM[] = INCBIN_U32("graphics/object_events/pics/hoenn/aqua_member_m.4bpp");
const u16 gObjectEventPal_HoennNpc4[] = INCBIN_U16("graphics/object_events/palettes/hoenn/npc4.gbapal");
const u32 gObjectEventPic_HoennAquaMemberF[] = INCBIN_U32("graphics/object_events/pics/hoenn/aqua_member_f.4bpp");
const u32 gObjectEventPic_HoennMagmaMemberM[] = INCBIN_U32("graphics/object_events/pics/hoenn/magma_member_m.4bpp");
const u16 gObjectEventPal_HoennNpc2[] = INCBIN_U16("graphics/object_events/palettes/hoenn/npc2.gbapal");
const u32 gObjectEventPic_HoennMagmaMemberF[] = INCBIN_U32("graphics/object_events/pics/hoenn/magma_member_f.4bpp");
const u32 gObjectEventPic_HoennArchie[] = INCBIN_U32("graphics/object_events/pics/hoenn/archie.4bpp");
const u16 gObjectEventPal_HoennNpc1[] = INCBIN_U16("graphics/object_events/palettes/hoenn/npc1.gbapal");
const u32 gObjectEventPic_HoennMaxie[] = INCBIN_U32("graphics/object_events/pics/hoenn/maxie.4bpp");
const u32 gObjectEventPic_HoennSteven[] = INCBIN_U32("graphics/object_events/pics/hoenn/steven.4bpp");
const u32 gObjectEventPic_HoennScott[] = INCBIN_U32("graphics/object_events/pics/hoenn/scott.4bpp");
const u32 gObjectEventPic_HoennWally[] = INCBIN_U32("graphics/object_events/pics/hoenn/wally.4bpp");
const u32 gObjectEventPic_HoennProfBirch[] = INCBIN_U32("graphics/object_events/pics/hoenn/prof_birch.4bpp");
const u16 gObjectEventPal_HoennNpc3[] = INCBIN_U16("graphics/object_events/palettes/hoenn/npc3.gbapal");
const u32 gObjectEventPic_HoennBrendanNormal[] = INCBIN_U32("graphics/object_events/pics/hoenn/brendan_normal.4bpp");
const u32 gObjectEventPic_HoennBrendanRunning[] = INCBIN_U32("graphics/object_events/pics/hoenn/brendan_running.4bpp");
const u16 gObjectEventPal_HoennBrendan[] = INCBIN_U16("graphics/object_events/palettes/hoenn/brendan.gbapal");
const u32 gObjectEventPic_HoennMayNormal[] = INCBIN_U32("graphics/object_events/pics/hoenn/may_normal.4bpp");
const u32 gObjectEventPic_HoennMayRunning[] = INCBIN_U32("graphics/object_events/pics/hoenn/may_running.4bpp");
const u16 gObjectEventPal_HoennMay[] = INCBIN_U16("graphics/object_events/palettes/hoenn/may.gbapal");
const u32 gObjectEventPic_HoennRoxanne[] = INCBIN_U32("graphics/object_events/pics/hoenn/roxanne.4bpp");
const u32 gObjectEventPic_HoennBrawly[] = INCBIN_U32("graphics/object_events/pics/hoenn/brawly.4bpp");
const u32 gObjectEventPic_HoennWattson[] = INCBIN_U32("graphics/object_events/pics/hoenn/wattson.4bpp");
const u32 gObjectEventPic_HoennFlannery[] = INCBIN_U32("graphics/object_events/pics/hoenn/flannery.4bpp");
const u32 gObjectEventPic_HoennNorman[] = INCBIN_U32("graphics/object_events/pics/hoenn/norman.4bpp");
const u32 gObjectEventPic_HoennWinona[] = INCBIN_U32("graphics/object_events/pics/hoenn/winona.4bpp");
const u32 gObjectEventPic_HoennTate[] = INCBIN_U32("graphics/object_events/pics/hoenn/tate.4bpp");
const u32 gObjectEventPic_HoennLiza[] = INCBIN_U32("graphics/object_events/pics/hoenn/liza.4bpp");
const u32 gObjectEventPic_HoennJuan[] = INCBIN_U32("graphics/object_events/pics/hoenn/juan.4bpp");
const u32 gObjectEventPic_HoennWallace[] = INCBIN_U32("graphics/object_events/pics/hoenn/wallace.4bpp");
const u32 gObjectEventPic_HoennSidney[] = INCBIN_U32("graphics/object_events/pics/hoenn/sidney.4bpp");
const u32 gObjectEventPic_HoennPhoebe[] = INCBIN_U32("graphics/object_events/pics/hoenn/phoebe.4bpp");
const u32 gObjectEventPic_HoennGlacia[] = INCBIN_U32("graphics/object_events/pics/hoenn/glacia.4bpp");
const u32 gObjectEventPic_HoennDrake[] = INCBIN_U32("graphics/object_events/pics/hoenn/drake.4bpp");
const u32 gObjectEventPic_HoennNinjaBoy[] = INCBIN_U32("graphics/object_events/pics/hoenn/ninja_boy.4bpp");
const u32 gObjectEventPic_HoennHexManiac[] = INCBIN_U32("graphics/object_events/pics/hoenn/hex_maniac.4bpp");
const u32 gObjectEventPic_HoennRichBoy[] = INCBIN_U32("graphics/object_events/pics/hoenn/rich_boy.4bpp");
const u32 gObjectEventPic_HoennSchoolKidM[] = INCBIN_U32("graphics/object_events/pics/hoenn/school_kid_m.4bpp");
const u32 gObjectEventPic_HoennCyclingTriathleteM[] = INCBIN_U32("graphics/object_events/pics/hoenn/cycling_triathlete_m.4bpp");
const u32 gObjectEventPic_HoennCyclingTriathleteF[] = INCBIN_U32("graphics/object_events/pics/hoenn/cycling_triathlete_f.4bpp");
const u32 gObjectEventPic_HoennRunningTriathleteM[] = INCBIN_U32("graphics/object_events/pics/hoenn/running_triathlete_m.4bpp");
const u32 gObjectEventPic_HoennRunningTriathleteF[] = INCBIN_U32("graphics/object_events/pics/hoenn/running_triathlete_f.4bpp");
const u32 gObjectEventPic_HoennDevonEmployee[] = INCBIN_U32("graphics/object_events/pics/hoenn/devon_employee.4bpp");
const u32 gObjectEventPic_HoennContestJudge[] = INCBIN_U32("graphics/object_events/pics/hoenn/contest_judge.4bpp");
const u32 gObjectEventPic_HoennKecleon[] = INCBIN_U32("graphics/object_events/pics/hoenn/kecleon.4bpp");
const u32 gObjectEventPic_HoennWingull[] = INCBIN_U32("graphics/object_events/pics/hoenn/wingull.4bpp");
const u32 gObjectEventPic_HoennPoochyena[] = INCBIN_U32("graphics/object_events/pics/hoenn/poochyena.4bpp");
const u16 gObjectEventPal_HoennPoochyena[] = INCBIN_U16("graphics/object_events/palettes/hoenn/poochyena.gbapal");
const u32 gObjectEventPic_HoennEnemyZigzagoon[] = INCBIN_U32("graphics/object_events/pics/hoenn/enemy_zigzagoon.4bpp");
const u16 gObjectEventPal_HoennEnemyZigzagoon[] = INCBIN_U16("graphics/object_events/palettes/hoenn/enemy_zigzagoon.gbapal");
const u32 gObjectEventPic_HoennZigzagoon[] = INCBIN_U32("graphics/object_events/pics/hoenn/zigzagoon.4bpp");
const u32 gObjectEventPic_HoennAzurill[] = INCBIN_U32("graphics/object_events/pics/hoenn/azurill.4bpp");
const u32 gObjectEventPic_HoennAzumarill[] = INCBIN_U32("graphics/object_events/pics/hoenn/azumarill.4bpp");
const u32 gObjectEventPic_HoennSkitty[] = INCBIN_U32("graphics/object_events/pics/hoenn/skitty.4bpp");
const u32 gObjectEventPic_HoennSudowoodo[] = INCBIN_U32("graphics/object_events/pics/hoenn/sudowoodo.4bpp");
const u32 gObjectEventPic_HoennKirlia[] = INCBIN_U32("graphics/object_events/pics/hoenn/kirlia.4bpp");
const u32 gObjectEventPic_HoennDusclops[] = INCBIN_U32("graphics/object_events/pics/hoenn/dusclops.4bpp");
const u32 gObjectEventPic_HoennVigoroth[] = INCBIN_U32("graphics/object_events/pics/hoenn/vigoroth.4bpp");
const u16 gObjectEventPal_HoennVigoroth[] = INCBIN_U16("graphics/object_events/palettes/hoenn/vigoroth.gbapal");
const u32 gObjectEventPic_HoennSSTidal[] = INCBIN_U32("graphics/object_events/pics/hoenn/s_s_tidal.4bpp");
const u16 gObjectEventPal_HoennSSTidal[] = INCBIN_U16("graphics/object_events/palettes/hoenn/s_s_tidal.gbapal");
const u32 gObjectEventPic_HoennMrBrineysBoat[] = INCBIN_U32("graphics/object_events/pics/hoenn/mr_brineys_boat.4bpp");
const u32 gObjectEventPic_HoennCableCar[] = INCBIN_U32("graphics/object_events/pics/hoenn/cable_car.4bpp");
const u16 gObjectEventPal_HoennCableCar[] = INCBIN_U16("graphics/object_events/palettes/hoenn/cable_car.gbapal");
const u32 gObjectEventPic_HoennSubmarineShadow[] = INCBIN_U32("graphics/object_events/pics/hoenn/submarine_shadow.4bpp");
const u16 gObjectEventPal_HoennSubmarineShadow[] = INCBIN_U16("graphics/object_events/palettes/hoenn/submarine_shadow.gbapal");
const u32 gObjectEventPic_HoennMovingBox[] = INCBIN_U32("graphics/object_events/pics/hoenn/moving_box.4bpp");
const u16 gObjectEventPal_HoennMovingBox[] = INCBIN_U16("graphics/object_events/palettes/hoenn/moving_box.gbapal");
const u32 gObjectEventPic_HoennStatue[] = INCBIN_U32("graphics/object_events/pics/hoenn/statue.4bpp");
const u32 gObjectEventPic_HoennBirchsBag[] = INCBIN_U32("graphics/object_events/pics/hoenn/birchs_bag.4bpp");
const u32 gObjectEventPic_HoennRegi[] = INCBIN_U32("graphics/object_events/pics/hoenn/regi.4bpp");
