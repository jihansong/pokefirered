...
// The airliners parked on the Vermilion airport's aprons. They share the
// truck's palette, which already has the white, grey and blue the livery needs.
...
// The airliner seen far off through the lounge window: half the parked
// plane's size, in a 16x16 frame, with the same facings and palette.
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_AirplaneSmall = {
    ...
    .subspriteTables = gObjectEventSpriteOamTables_16x16,
    .anims = sAnimTable_Airplane,
    .images = sPicTable_AirplaneSmall,
    .affineAnims = gDummySpriteAffineAnimTable,
};
