const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    {.size = 8, .y_offset = 1}, // TRAINER_PIC_HOENN_LEADER_JUAN
    // END HOENN TRAINERS
    [TRAINER_PIC_OLD_TIMER] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_N] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_SUMMIT_TRAINER] = {.size = 8, .y_offset = 1},
};
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(HOENN_LEADER_JUAN, gTrainerFrontPic_HoennLeaderJuan, 0x800),
    TRAINER_SPRITE(OLD_TIMER, gTrainerFrontPic_BugCatcher, 0x800),
    TRAINER_SPRITE(N, gTrainerFrontPic_CooltrainerM, 0x800),
    TRAINER_SPRITE(SUMMIT_TRAINER, gTrainerFrontPic_Red, 0x800),
};
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(HOENN_LEADER_JUAN, gTrainerPalette_HoennLeaderJuan),
    TRAINER_PAL(OLD_TIMER, gTrainerPalette_OldTimer),
    TRAINER_PAL(N, gTrainerPalette_N),
    TRAINER_PAL(SUMMIT_TRAINER, gTrainerPalette_SummitTrainer),
};
