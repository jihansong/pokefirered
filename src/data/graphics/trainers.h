...
const u32 gTrainerFrontPic_HoennLeaderJuan[] = INCBIN_U32("graphics/trainers/front_pics/hoenn_leader_juan_front_pic.4bpp.lz");
const u32 gTrainerPalette_HoennLeaderJuan[] = INCBIN_U32("graphics/trainers/palettes/hoenn_leader_juan.gbapal.lz");
// END HOENN TRAINERS
