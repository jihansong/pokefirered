...
// BEGIN HOENN OBJECT EVENT DECLARATIONS (generated by tools/hoenn_import/import_objevent_gfx.py)
...
// END HOENN OBJECT EVENT DECLARATIONS
...
// BEGIN HOENN OBJECT EVENTS (generated by tools/hoenn_import/import_objevent_gfx.py)
    [OBJ_EVENT_GFX_AQUA_MEMBER_M] = &gObjectEventGraphicsInfo_HoennAquaMemberM,
    [OBJ_EVENT_GFX_AQUA_MEMBER_F] = &gObjectEventGraphicsInfo_HoennAquaMemberF,
    [OBJ_EVENT_GFX_MAGMA_MEMBER_M] = &gObjectEventGraphicsInfo_HoennMagmaMemberM,
    [OBJ_EVENT_GFX_MAGMA_MEMBER_F] = &gObjectEventGraphicsInfo_HoennMagmaMemberF,
    [OBJ_EVENT_GFX_ARCHIE] = &gObjectEventGraphicsInfo_HoennArchie,
    [OBJ_EVENT_GFX_MAXIE] = &gObjectEventGraphicsInfo_HoennMaxie,
    [OBJ_EVENT_GFX_STEVEN] = &gObjectEventGraphicsInfo_HoennSteven,
    [OBJ_EVENT_GFX_SCOTT] = &gObjectEventGraphicsInfo_HoennScott,
    [OBJ_EVENT_GFX_WALLY] = &gObjectEventGraphicsInfo_HoennWally,
    [OBJ_EVENT_GFX_PROF_BIRCH] = &gObjectEventGraphicsInfo_HoennProfBirch,
    [OBJ_EVENT_GFX_RIVAL_BRENDAN_NORMAL] = &gObjectEventGraphicsInfo_HoennRivalBrendanNormal,
    [OBJ_EVENT_GFX_RIVAL_MAY_NORMAL] = &gObjectEventGraphicsInfo_HoennRivalMayNormal,
    [OBJ_EVENT_GFX_ROXANNE] = &gObjectEventGraphicsInfo_HoennRoxanne,
    [OBJ_EVENT_GFX_BRAWLY] = &gObjectEventGraphicsInfo_HoennBrawly,
    [OBJ_EVENT_GFX_WATTSON] = &gObjectEventGraphicsInfo_HoennWattson,
    [OBJ_EVENT_GFX_FLANNERY] = &gObjectEventGraphicsInfo_HoennFlannery,
    [OBJ_EVENT_GFX_NORMAN] = &gObjectEventGraphicsInfo_HoennNorman,
    [OBJ_EVENT_GFX_WINONA] = &gObjectEventGraphicsInfo_HoennWinona,
    [OBJ_EVENT_GFX_TATE] = &gObjectEventGraphicsInfo_HoennTate,
    [OBJ_EVENT_GFX_LIZA] = &gObjectEventGraphicsInfo_HoennLiza,
    [OBJ_EVENT_GFX_JUAN] = &gObjectEventGraphicsInfo_HoennJuan,
    [OBJ_EVENT_GFX_WALLACE] = &gObjectEventGraphicsInfo_HoennWallace,
    [OBJ_EVENT_GFX_SIDNEY] = &gObjectEventGraphicsInfo_HoennSidney,
    [OBJ_EVENT_GFX_PHOEBE] = &gObjectEventGraphicsInfo_HoennPhoebe,
    [OBJ_EVENT_GFX_GLACIA] = &gObjectEventGraphicsInfo_HoennGlacia,
    [OBJ_EVENT_GFX_DRAKE] = &gObjectEventGraphicsInfo_HoennDrake,
    [OBJ_EVENT_GFX_NINJA_BOY] = &gObjectEventGraphicsInfo_HoennNinjaBoy,
    [OBJ_EVENT_GFX_HEX_MANIAC] = &gObjectEventGraphicsInfo_HoennHexManiac,
    [OBJ_EVENT_GFX_RICH_BOY] = &gObjectEventGraphicsInfo_HoennRichBoy,
    [OBJ_EVENT_GFX_SCHOOL_KID_M] = &gObjectEventGraphicsInfo_HoennSchoolKidM,
    [OBJ_EVENT_GFX_CYCLING_TRIATHLETE_M] = &gObjectEventGraphicsInfo_HoennCyclingTriathleteM,
    [OBJ_EVENT_GFX_CYCLING_TRIATHLETE_F] = &gObjectEventGraphicsInfo_HoennCyclingTriathleteF,
    [OBJ_EVENT_GFX_RUNNING_TRIATHLETE_M] = &gObjectEventGraphicsInfo_HoennRunningTriathleteM,
    [OBJ_EVENT_GFX_RUNNING_TRIATHLETE_F] = &gObjectEventGraphicsInfo_HoennRunningTriathleteF,
    [OBJ_EVENT_GFX_DEVON_EMPLOYEE] = &gObjectEventGraphicsInfo_HoennDevonEmployee,
    [OBJ_EVENT_GFX_CONTEST_JUDGE] = &gObjectEventGraphicsInfo_HoennContestJudge,
    [OBJ_EVENT_GFX_KECLEON] = &gObjectEventGraphicsInfo_HoennKecleon,
    [OBJ_EVENT_GFX_WINGULL] = &gObjectEventGraphicsInfo_HoennWingull,
    [OBJ_EVENT_GFX_POOCHYENA] = &gObjectEventGraphicsInfo_HoennPoochyena,
    [OBJ_EVENT_GFX_ZIGZAGOON_1] = &gObjectEventGraphicsInfo_HoennEnemyZigzagoon,
    [OBJ_EVENT_GFX_ZIGZAGOON_2] = &gObjectEventGraphicsInfo_HoennZigzagoon,
    [OBJ_EVENT_GFX_AZURILL] = &gObjectEventGraphicsInfo_HoennAzurill,
    [OBJ_EVENT_GFX_AZUMARILL] = &gObjectEventGraphicsInfo_HoennAzumarill,
    [OBJ_EVENT_GFX_SKITTY] = &gObjectEventGraphicsInfo_HoennSkitty,
    [OBJ_EVENT_GFX_SUDOWOODO] = &gObjectEventGraphicsInfo_HoennSudowoodo,
    [OBJ_EVENT_GFX_KIRLIA] = &gObjectEventGraphicsInfo_HoennKirlia,
    [OBJ_EVENT_GFX_DUSCLOPS] = &gObjectEventGraphicsInfo_HoennDusclops,
    [OBJ_EVENT_GFX_VIGOROTH_CARRYING_BOX] = &gObjectEventGraphicsInfo_HoennVigorothCarryingBox,
    [OBJ_EVENT_GFX_VIGOROTH_FACING_AWAY] = &gObjectEventGraphicsInfo_HoennVigorothFacingAway,
    [OBJ_EVENT_GFX_SS_TIDAL] = &gObjectEventGraphicsInfo_HoennSSTidal,
    [OBJ_EVENT_GFX_MR_BRINEYS_BOAT] = &gObjectEventGraphicsInfo_HoennMrBrineysBoat,
    [OBJ_EVENT_GFX_CABLE_CAR] = &gObjectEventGraphicsInfo_HoennCableCar,
    [OBJ_EVENT_GFX_SUBMARINE_SHADOW] = &gObjectEventGraphicsInfo_HoennSubmarineShadow,
    [OBJ_EVENT_GFX_MOVING_BOX] = &gObjectEventGraphicsInfo_HoennMovingBox,
    [OBJ_EVENT_GFX_TRICK_HOUSE_STATUE] = &gObjectEventGraphicsInfo_HoennStatue,
    [OBJ_EVENT_GFX_BIRCHS_BAG] = &gObjectEventGraphicsInfo_HoennBirchsBag,
    [OBJ_EVENT_GFX_REGIROCK] = &gObjectEventGraphicsInfo_HoennRegirock,
    [OBJ_EVENT_GFX_REGICE] = &gObjectEventGraphicsInfo_HoennRegice,
    [OBJ_EVENT_GFX_REGISTEEL] = &gObjectEventGraphicsInfo_HoennRegisteel,
