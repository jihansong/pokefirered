...
$(OBJEVENTGFXDIR)/hoenn/aqua_member_m.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/aqua_member_f.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/magma_member_m.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/magma_member_f.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/archie.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/maxie.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/steven.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/scott.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/wally.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/prof_birch.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/brendan_normal.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/brendan_running.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/may_normal.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/may_running.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/roxanne.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/brawly.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/wattson.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/flannery.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/norman.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/winona.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/tate.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/liza.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/juan.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/wallace.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/sidney.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/phoebe.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/glacia.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/drake.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/ninja_boy.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 2
$(OBJEVENTGFXDIR)/hoenn/hex_maniac.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/rich_boy.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/school_kid_m.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/cycling_triathlete_m.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/cycling_triathlete_f.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/running_triathlete_m.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/running_triathlete_f.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/devon_employee.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/contest_judge.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/kecleon.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 2
$(OBJEVENTGFXDIR)/hoenn/wingull.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 2
$(OBJEVENTGFXDIR)/hoenn/poochyena.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/enemy_zigzagoon.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/zigzagoon.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 2
$(OBJEVENTGFXDIR)/hoenn/azurill.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 2
$(OBJEVENTGFXDIR)/hoenn/azumarill.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 2
$(OBJEVENTGFXDIR)/hoenn/skitty.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 2
$(OBJEVENTGFXDIR)/hoenn/sudowoodo.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/kirlia.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/dusclops.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/vigoroth.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
$(OBJEVENTGFXDIR)/hoenn/mr_brineys_boat.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
