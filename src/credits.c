...
// Thunder Yellow: the staff pages are 249 frames shorter in all (6 frames each,
// 5 for the three ROUTE 23 pages), which is what the THUNDER_YELLOW page
// adds, so the roll keeps the original's length against MUS_CREDITS: THE END
// starts where it did before the page (tools/qa/creditstime.py, against v0.8.0).
static const struct CreditsScrcmd sCreditsScript[] = {
    CREDITS_MAPNEXT(ROUTE23, 16),
    CREDITS_PRINT(DIRECTOR, 295),
    CREDITS_PRINT(ART_DIRECTOR_BATTLE_DIRECTOR, 295),
    CREDITS_PRINT(PROGRAM_LEADER_PLANNING_LEADER_GRAPHIC_DESIGN_LEADER, 295),
    CREDITS_PRINT(DUMMY, 60),
    CREDITS_MAPNEXT(VIRIDIAN_CITY, 0),
    CREDITS_PRINT(PROGRAMMERS, 205),
    CREDITS_PRINT(SYSTEM_PROGRAMMERS, 205),
    CREDITS_PRINT(GRAPHIC_DESIGNERS, 205),
    CREDITS_MAPNEXT(PEWTER_CITY, 0),
    CREDITS_PRINT(GRAPHIC_DESIGNERS_2, 205),
    CREDITS_PRINT(MUSIC_COMPOSITION, 204),
    CREDITS_PRINT(SOUND_EFFECTS, 204),
    CREDITS_MON(CHARIZARD),
    CREDITS_MAP(CERULEAN_CITY, 16),
    CREDITS_PRINT(GAME_DESIGNERS, 205),
    CREDITS_PRINT(GAME_DESIGNERS_2, 204),
    CREDITS_PRINT(GAME_SCENARIO, 204),
    CREDITS_MAPNEXT(ROUTE25, 16),
    CREDITS_PRINT(SCRIPT_DESIGNER_MAP_DESIGNER, 205),
    CREDITS_PRINT(PARAMETRIC_DESIGNERS, 204),
    CREDITS_PRINT(POKEDEX_TEXT, 204),
    CREDITS_MAPNEXT(VERMILION_CITY, 16),
    CREDITS_PRINT(POKEMON_DESIGNERS, 205),
    CREDITS_PRINT(POKEMON_DESIGNERS_2, 204),
    CREDITS_PRINT(POKEMON_DESIGNERS_3, 204),
    CREDITS_MON(VENUSAUR),
    CREDITS_MAP(ROUTE10, 16),
    CREDITS_PRINT(SUPPORTING_PROGRAMMERS, 205),
    CREDITS_PRINT(NCL_PRODUCT_TESTING, 204),
    CREDITS_PRINT(SPECIAL_THANKS, 204),
    CREDITS_MAPNEXT(CELADON_CITY, 16),
    CREDITS_PRINT(SPECIAL_THANKS_2, 215),
    CREDITS_PRINT(SPECIAL_THANKS_3, 215),
    CREDITS_PRINT(BRAILLE_CODE_CHECK, 215),
    CREDITS_PRINT(INFORMATION_SUPERVISORS, 215),
    CREDITS_PRINT(DUMMY, 51),
    CREDITS_MAPNEXT(SAFFRON_CITY, 16),
    CREDITS_PRINT(COORDINATORS, 205),
    CREDITS_PRINT(TASK_MANAGERS, 204),
    CREDITS_PRINT(PRODUCERS, 204),
    CREDITS_MON(BLASTOISE),
    CREDITS_MAP(ROUTE17, 16),
    CREDITS_PRINT(EXECUTIVE_DIRECTOR, 325),
    CREDITS_PRINT(EXECUTIVE_PRODUCER, 325),
    CREDITS_PRINT(EXECUTIVE_PRODUCER_2, 325),
    CREDITS_MAPNEXT(FUCHSIA_CITY, 16),
    CREDITS_PRINT(ENGLISH_VERSION_COORDINATORS, 215),
    CREDITS_PRINT(TRANSLATOR_TEXT_EDITOR, 215),
    CREDITS_PRINT(PROGRAMMERS_2, 215),
    CREDITS_PRINT(ENVIRONMENT_TOOL_PROGRAMMERS, 215),
    CREDITS_PRINT(DUMMY, 52),
    CREDITS_MAPNEXT(CINNABAR_ISLAND, 16),
    CREDITS_PRINT(GRAPHIC_DESIGNER, 204),
    CREDITS_PRINT(NOA_PRODUCT_TESTING, 204),
    CREDITS_PRINT(BRAILLE_CODE_CHECK_2, 205),
    CREDITS_MON(PIKACHU),
    CREDITS_MAP(ROUTE21_NORTH, 16),
    CREDITS_PRINT(BRAILLE_CODE_CHECK_3, 215),
    CREDITS_PRINT(BRAILLE_CODE_CHECK_4, 215),
    CREDITS_PRINT(SPECIAL_THANKS_4, 215),
    CREDITS_PRINT(SPECIAL_THANKS_5, 215),
