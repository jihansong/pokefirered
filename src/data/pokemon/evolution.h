// Thunder Yellow: trade evolutions also work without trading. The ones without
// an item happen at Lv37. The held-item ones happen on level-up while holding
// the item (EVO_LEVEL_HOLD_ITEM) instead of by trade.
const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PIKACHU]    = {{EVO_ITEM_UNLESS_STARTER_PIKACHU, ITEM_THUNDER_STONE, SPECIES_RAICHU}},
    ...
    [SPECIES_POLIWHIRL]  = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_POLIWRATH},
                            {EVO_LEVEL_HOLD_ITEM, EVO_HOLD_ITEM_PARAM(ITEM_KINGS_ROCK, 30), SPECIES_POLITOED}},
    ...
    [SPECIES_SLOWPOKE]   = {{EVO_LEVEL, 37, SPECIES_SLOWBRO},
                            {EVO_LEVEL_HOLD_ITEM, EVO_HOLD_ITEM_PARAM(ITEM_KINGS_ROCK, 37), SPECIES_SLOWKING}},
    ...
    [SPECIES_ONIX]       = {{EVO_LEVEL_HOLD_ITEM, EVO_HOLD_ITEM_PARAM(ITEM_METAL_COAT, 30), SPECIES_STEELIX}},
    ...
    [SPECIES_SEADRA]     = {{EVO_LEVEL_HOLD_ITEM, EVO_HOLD_ITEM_PARAM(ITEM_DRAGON_SCALE, 40), SPECIES_KINGDRA}},
    [SPECIES_GOLDEEN]    = {{EVO_LEVEL, 33, SPECIES_SEAKING}},
    [SPECIES_STARYU]     = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_STARMIE}},
    [SPECIES_SCYTHER]    = {{EVO_LEVEL_HOLD_ITEM, EVO_HOLD_ITEM_PARAM(ITEM_METAL_COAT, 30), SPECIES_SCIZOR}},
    ...
    [SPECIES_PORYGON]    = {{EVO_LEVEL_HOLD_ITEM, EVO_HOLD_ITEM_PARAM(ITEM_UP_GRADE, 30), SPECIES_PORYGON2}},
    ...
    [SPECIES_CLAMPERL]   = {{EVO_LEVEL_HOLD_ITEM, EVO_HOLD_ITEM_PARAM(ITEM_DEEP_SEA_TOOTH, 30), SPECIES_HUNTAIL},
                            {EVO_LEVEL_HOLD_ITEM, EVO_HOLD_ITEM_PARAM(ITEM_DEEP_SEA_SCALE, 30), SPECIES_GOREBYSS}},
