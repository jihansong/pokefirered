...
const u32 gItemIconPalette_OddFragment[] = INCBIN_U32("graphics/items/icon_palettes/odd_fragment.gbapal.lz");
...
const u32 gItemIconPalette_EnigmaStone[] = INCBIN_U32("graphics/items/icon_palettes/enigma_stone.gbapal.lz");
