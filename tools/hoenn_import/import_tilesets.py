...
MANUAL = {
    ...
    # FR/LG blocks one direction per behavior, so a two-way block keeps the first half
    'MB_IMPASSABLE_SOUTH_AND_NORTH': 'MB_IMPASSABLE_NORTH', 'MB_IMPASSABLE_WEST_AND_EAST': 'MB_IMPASSABLE_WEST',
    # Hoenn's bridges, logs and treetop walkways are walkable through their collision
    # and elevation, which carry over, so the behavior itself can be plain ground.
    'MB_BRIDGE_OVER_OCEAN': 'MB_NORMAL', 'MB_BRIDGE_OVER_POND_LOW': 'MB_NORMAL',
    'MB_BRIDGE_OVER_POND_MED': 'MB_NORMAL', 'MB_BRIDGE_OVER_POND_HIGH': 'MB_NORMAL',
    'MB_BRIDGE_OVER_POND_MED_EDGE_1': 'MB_NORMAL', 'MB_BRIDGE_OVER_POND_MED_EDGE_2': 'MB_NORMAL',
    'MB_BRIDGE_OVER_POND_HIGH_EDGE_1': 'MB_NORMAL', 'MB_BRIDGE_OVER_POND_HIGH_EDGE_2': 'MB_NORMAL',
    'MB_BIKE_BRIDGE_OVER_BARRIER': 'MB_NORMAL', 'MB_FORTREE_BRIDGE': 'MB_NORMAL',
    'MB_PACIFIDLOG_HORIZONTAL_LOG_LEFT': 'MB_NORMAL', 'MB_PACIFIDLOG_HORIZONTAL_LOG_RIGHT': 'MB_NORMAL',
    'MB_PACIFIDLOG_VERTICAL_LOG_TOP': 'MB_NORMAL', 'MB_PACIFIDLOG_VERTICAL_LOG_BOTTOM': 'MB_NORMAL',
    # Emerald's bike terrain and the SKY PILLAR's cracked floor become plain ground:
    # FR/LG has neither the Mach and Acro bikes nor the falling floor.
    'MB_MUDDY_SLOPE': 'MB_NORMAL', 'MB_BUMPY_SLOPE': 'MB_NORMAL', 'MB_CRACKED_FLOOR': 'MB_NORMAL',
    'MB_VERTICAL_RAIL': 'MB_NORMAL', 'MB_HORIZONTAL_RAIL': 'MB_NORMAL',
    'MB_ISOLATED_VERTICAL_RAIL': 'MB_NORMAL', 'MB_ISOLATED_HORIZONTAL_RAIL': 'MB_NORMAL',
}
