...
static const u8 sTextColorTable[] =
{
 // [LOW_NYBBLE / 2]                            = 0xXY, // HIGH_NYBBLE
    ...
    [OBJ_EVENT_GFX_JESSIE / 2]                  = COLORS(NPC_TEXT_COLOR_FEMALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_JAMES
    [OBJ_EVENT_GFX_TRUCK / 2]                   = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_MON), // OBJ_EVENT_GFX_PIKABLU
    [OBJ_EVENT_GFX_MEWTWO_SHADOW / 2]           = COLORS(NPC_TEXT_COLOR_MON, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_CAPSULE_SHARDS
    [OBJ_EVENT_GFX_RED_GYARADOS / 2]            = COLORS(NPC_TEXT_COLOR_MON, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_PERSIAN_STATUE
    [OBJ_EVENT_GFX_DITTO / 2]                   = COLORS(NPC_TEXT_COLOR_MON, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_GROTTO_GRASS
    [OBJ_EVENT_GFX_PLUSLE / 2]                  = COLORS(NPC_TEXT_COLOR_MON, NPC_TEXT_COLOR_MON), // OBJ_EVENT_GFX_MINUN
    [OBJ_EVENT_GFX_TOGEPI / 2]                  = COLORS(NPC_TEXT_COLOR_MON, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_OAK_TROPHY
    [OBJ_EVENT_GFX_CLEFABLE / 2]                = COLORS(NPC_TEXT_COLOR_MON, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_MOON_STONE
    [OBJ_EVENT_GFX_KYOGRE / 2]                  = COLORS(NPC_TEXT_COLOR_MON, NPC_TEXT_COLOR_MON), // OBJ_EVENT_GFX_GROUDON
    [OBJ_EVENT_GFX_RAYQUAZA / 2]                = COLORS(NPC_TEXT_COLOR_MON, NPC_TEXT_COLOR_NEUTRAL),
};
