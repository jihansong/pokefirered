static const u32 *const sItemIconTable[ITEMS_COUNT + 1][2] =
{
    ...
    // ????????
    [ITEM_MYSTIC_SHARD]   = {gItemIcon_Shard, gItemIconPalette_MysticShard},
    [ITEM_RED_SCALE]      = {gItemIcon_DragonScale, gItemIconPalette_RedScale},
    [ITEM_ENIGMA_STONE]   = {gItemIcon_MoonStone, gItemIconPalette_EnigmaStone},
    [ITEM_ODD_FRAGMENT]   = {gItemIcon_Shard, gItemIconPalette_OddFragment},
    [ITEM_FINAL_NOTES]    = {gItemIcon_Letter, gItemIconPalette_LavaCookieAndLetter},
    [ITEM_POKE_WATCH]     = {gItemIcon_PokeWatch, gItemIconPalette_PokeWatch},
    [ITEM_CARGO_TAG]      = {gItemIcon_CleanseTag, gItemIconPalette_CleanseTag},
    [ITEM_N_LETTER]       = {gItemIcon_Letter, gItemIconPalette_LavaCookieAndLetter},
