#ifndef GUARD_METATILE_LABELS_HOENN_H
#define GUARD_METATILE_LABELS_HOENN_H

// Metatile ids for the imported Hoenn maps. The import keeps pokeemerald's
// tilesets byte for byte, so these are Emerald's own numbers.

// MAUVILLE CITY GYM (the electric barrier puzzle)
...
#endif // GUARD_METATILE_LABELS_HOENN_H
