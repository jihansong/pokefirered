...
const u8 gText_KantoArea[] = _("KANTO AREA");
const u8 gText_DexAbility[] = _("ABILITY");
const u8 gText_DexAbilityUnknown[] = _("?????");
const u8 gText_HoennArea[] = _("HOENN AREA");
const u8 gText_AreaRegionSwitch[] = _("{SELECT_BUTTON}REGION");
...
ALIGNED(4) const u8 gCreditsString_POKeMON_Thunder_Yellow[] = _("\n\nPOKéMON Thunder Yellow\n\n\n\n");
ALIGNED(4) const u8 gCreditsString_Joseph_Song[] = _("\n\n\nJoseph Song\n\n\n");
