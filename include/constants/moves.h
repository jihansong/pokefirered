...
#define MOVE_VOLT_STRIKE 355 // Thunder Yellow: Oak's PIKACHU learns it at Lv55
...
#define MOVETUTOR_PIKACHU_SURF 18 // Route 19 surfer, starter PIKACHU only
#define MOVETUTOR_PIKACHU_FLY  19
#define MOVETUTOR_PIKACHU_VOLT_TACKLE 20 // POWER PLANT, starter PIKACHU only

// CheckVoltTackleConditions
#define VOLT_TACKLE_READY            0
#define VOLT_TACKLE_NOT_LEAD_PIKACHU 1
#define VOLT_TACKLE_LOW_FRIENDSHIP   2
#define VOLT_TACKLE_LOW_LEVEL        3
#define VOLT_TACKLE_ALREADY_KNOWN    4
