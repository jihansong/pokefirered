...
#define TUTOR_MOVE_PIKACHU_SURF    MOVETUTOR_PIKACHU_SURF
#define TUTOR_MOVE_PIKACHU_FLY     MOVETUTOR_PIKACHU_FLY
#define TUTOR_MOVE_PIKACHU_VOLT_TACKLE MOVETUTOR_PIKACHU_VOLT_TACKLE
